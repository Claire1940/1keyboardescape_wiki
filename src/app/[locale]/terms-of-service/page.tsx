...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - +1 Speed Keyboard Escape Wiki",
    description: "Read the Terms of Service for +1 Speed Keyboard Escape Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - +1 Speed Keyboard Escape Wiki",
      description: "Terms and conditions for using +1 Speed Keyboard Escape Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using +1 Speed Keyboard Escape Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using +1 Speed Keyboard Escape Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and +1 Speed Keyboard Escape Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              +1 Speed Keyboard Escape Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "+1 Speed Keyboard Escape". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active and expired Roblox codes, redeem steps, and rewards</li>
              <li>Beginner guides and how-to-play basics</li>
              <li>Speed farming, treadmills, and multiplier upgrade tips</li>
              <li>Rebirth strategy and progression walkthroughs</li>
              <li>Worlds, stages, trails, auras, and event coverage</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> +1 Speed Keyboard Escape Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation (Roblox) or the official developers of +1 Speed Keyboard Escape. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by +1 Speed Keyboard Escape Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation (Roblox) and/or the developers of +1 Speed Keyboard Escape. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, +1 SPEED KEYBOARD ESCAPE WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and +1 Speed Keyboard Escape Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@1keyboardescape.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@1keyboardescape.wiki</a>
            </p>
            <p>
