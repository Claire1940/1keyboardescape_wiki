...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - +1 Speed Keyboard Escape Wiki',
    description: 'Copyright and intellectual property information for +1 Speed Keyboard Escape Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - +1 Speed Keyboard Escape Wiki',
      description: 'Copyright and intellectual property information for +1 Speed Keyboard Escape Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 +1 Speed Keyboard Escape Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of +1 Speed Keyboard Escape Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              +1 Speed Keyboard Escape Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>SecretVerse Studio</strong> - Developer of the +1 Speed Keyboard Escape game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>+1 Speed Keyboard Escape</strong> - Trademark of SecretVerse Studio</li>
              <li><strong>+1 Speed Keyboard Escape Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with +1 Speed Keyboard Escape Wiki.
            </p>
            ...
            <p>
              ...
              +1 Speed Keyboard Escape Wiki<br />
              Email: <a href="mailto:dmca@1keyboardescape.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@1keyboardescape.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "+1 Speed Keyboard Escape Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: +1 Speed Keyboard Escape Wiki (1keyboardescape.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@1keyboardescape.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@1keyboardescape.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@1keyboardescape.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@1keyboardescape.wiki</a>
            </p>
            <p>
